...
get_scan_types() {
    ...
    echo "Executing: python3 -m xnat_cli_scripts.projects $2 --get --scan_types"
    python3 -m xnat_cli_scripts.projects $2 --get --scan_types
}
...
get_scan_types "$BASE_FOLDER" "$BOILER_PLATE"
