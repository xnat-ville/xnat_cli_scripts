...
update_anon_scripts_json_files() {
    export PYTHONPATH="$1/../src"

    echo python3 -m xnat_cli_scripts.projects $2 --update --anon --input_folder $3 
         python3 -m xnat_cli_scripts.projects $2 --update --anon --input_folder $3 
}
