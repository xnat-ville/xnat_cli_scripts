...
list_projects() {
    ...
    echo "python3 -m xnat_cli_scripts.projects $2 --list > $3"
          python3 -m xnat_cli_scripts.projects $2 --list > $3
}
...
mkdir -p test_data
list_projects "$BASE_FOLDER" "$BOILER_PLATE" test_data/projects.txt
